...
export const useWheels = (width, height, front, radius) => {
    ...
    const wheelInfos = [//aplica os parametros em cada roda
        {
          ...wheelInfo,
        ...
        shapes: [
          {
            ...
            type: "Cylinder",//vai ser um cilindro
          },
        ],
        type: "Kinematic",//possue movimento mais n é afetado por coisas esternas
      });
